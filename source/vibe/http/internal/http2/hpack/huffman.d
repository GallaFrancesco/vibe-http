...
@safe
{
	enforceHPACK(state < 256 && pos < 16, "Invalid HPACK table entry reference");
	auto entry = HuffDecodeCodes[state][pos];
	enforceHPACK(entry.next != state, "Invalid HPACK table symbol");
...
unittest { // should be @nogc, but exceptions
	import vibe.internal.array : BatchBuffer;
